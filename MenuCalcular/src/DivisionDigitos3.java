 ...
 * @author Dedosjr
 */
public class DivisionDigitos3 extends javax.swing.JInternalFrame {

    /**
     * Creates new form Suma
     */
    public DivisionDigitos3() {
        initComponents();
    }
    ...
    private void botonGenrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonGenrarActionPerformed
        ...
        num1= 1+(int)(Math.random()*(999-100+1)+100);
        num2= 2+(int)(Math.random()*(999-100+1)+100);
  ...
  float resultado, total,num1, num2;
   num1 = Integer.parseInt(this.Num1.getText());
   num2 = Integer.parseInt(this.Num2.getText());
   resultado= Float.parseFloat(this.Resultado.getText());   
   total = num1/num2; 
   
     if (num1==0)
        Mensaje.setText("0 No es divisible");
   else if (num2==0)
        Mensaje.setText("0 No es divisible");
   else
